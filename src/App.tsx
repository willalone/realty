    ...
    switch (modal) {
      case 'promo1':
        return {
          ...
          content: `🎁 **Ремонт в подарок при покупке квартиры**

При покупке квартиры в наших ЖК вы получаете ремонт в подарок!

✨ **Что включено:**
• Чистовая отделка квартиры
• Качественные материалы
• Работы выполняют профессионалы
• Гарантия на выполненные работы

💰 **Условия акции:**
• Действует при покупке квартир в ЖК "ДОМ 101", "Народные кварталы"
• При единоразовом платеже или ипотеке
• Ограниченное количество предложений

📞 Подробности уточняйте у менеджера по телефону +7(861)211-28-50`
        };
      case 'promo2':
        return {
          title: 'Старт продаж',
          content: `🚀 **Старт продаж новых проектов**

Специальные условия для первых покупателей!

🎯 **Выгодные предложения:**
• Скидка до 12% от стоимости квартиры
• Рассрочка 0% на первые 6 месяцев
• Бесплатная юридическая поддержка
• Помощь в оформлении документов

🏠 **Участвующие проекты:**
• ЖК "ДОМ 101" - скидка 12%
• ЖК "Народные кварталы" - скидка 10%
• ЖК "История 2" - скидка 8%
